...
The purpose of the plugin is to download the characteristic cards of selected catchments from the website: `Jednolite cześci wód <http://karty.apgw.gov.pl:4200/informacje>`_` to the folder of a given project. `diversity indexes <https://en.wikipedia.org/wiki/Diversity_index>`_ .
